  ...
  return (
    <div className="bg-white rounded-sm p-4 cursor-pointer" onClick={handleClick}>
      <div className="flex justify-between items-center">
        ...
        <div
          className={`flex items-center gap-1.5 font-medium px-2 md:px-3 py-1 rounded-full ${
            ticket.status == "Open"
        ...
        >
          <span
            className={`w-3 md:w-4 h-3 md:h-4 rounded-full block ${
      ...
      <div className="flex justify-between items-center">
        <div className="font-medium text-sm flex justify-between gap-2 md:gap-4">
        ...
        <div className="text-sm text-[#627382] flex justify-between gap-2 md:gap-4">
